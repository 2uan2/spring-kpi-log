...
public class LoggingGrpcInterceptor implements ServerInterceptor {
    ...
    public <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(
        ...
        String actionName = extractActionName(fullMethodName);
        if (kpiLogInfo.getIgnoreGrpcMethods() != null && !kpiLogInfo.getIgnoreGrpcMethods().isEmpty() && kpiLogInfo.getIgnoreGrpcMethods().contains(actionName)) {
        ...
        kpiLog.setActionName(actionName);
